...
public class Sample {
	...
	public static void run(String imagePath) {
		try {
			...
			List<AbstractFile> files = sk.findAllFilesWhere("LOWER(name) LIKE LOWER('%.%')");
	...
	public static void main(String[] args) {
		Sample.run("/home/darryl/Downloads/BackupDisk.img");
		File file = new File("/home/darryl/Downloads/BackupDisk.img.db");
		file.delete();
